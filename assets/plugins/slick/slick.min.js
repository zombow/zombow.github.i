!function (i) {
    ...
    (e = 0, t = function (t, o) {
        ...
        var i, e, o = this, s = arguments[0], n = Array.prototype.slice.call(arguments, 1), r = o.length;
    ...
    i.fn.slickAnimation = function () {
        ...
        var s = i(this), n = s.find(".slick-list .slick-track > div"), r = s.find('[data-slick-index="0"]'),
            l = "animated", a = {opacity: "1"}, d = {opacity: "0"};
        return n.each(function () {
            var n = i(this);
            n.find("[data-animation-in]").each(function () {
                var c = i(this);
                c.css(d);
                var p = c.attr("data-animation-in"), u = c.attr("data-animation-out"), h = c.attr("data-delay-in"),
                    f = c.attr("data-duration-in"), v = c.attr("data-delay-out"), k = c.attr("data-duration-out");
