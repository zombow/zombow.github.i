!function (t, e) {
    ...
    var l = r, a = "undefined" != typeof Element ? Element.prototype : {},
    ...
    }, g.Scale = {VISIBLE: 1, HIDDEN: .001};
    var _ = null, E = function () {
        if (null !== _) return _;
    ...
    function S(t, e) {
        var i = Object.assign({}, b, e), n = Array.from(t), s = !1;
        ...
        return Object.keys(i).forEach(function (t) {
            ...
            if (h > 0) {
                ...
                (c = r.every(function (t) {
                    var e = new p(t.left + h, t.top, t.width, t.height, t.id), i = !n.some(function (t) {
    ...
    var O = 0, N = function (e) {
        ...
        return function (t, e) {
            ...
            key: "add", value: function (t) {
                var e = this, i = x(t).map(function (t) {
                    return new g(t)
                });
                this._initItems(i), this._resetCols();
                var n = S(this._mergeNewItems(i), this.lastSort), s = this._filter(this.lastFilter, n),
                    o = function (t) {
                        return i.includes(t)
                    }, r = function (t) {
            ...
            key: "getSize", value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    i = window.getComputedStyle(t, null), n = I(t, "width", i), s = I(t, "height", i);
    ...
    }, N.Classes = v, N.FilterMode = {ANY: "any", ALL: "all"}, N.options = {
        group: N.ALL_ITEMS,
        speed: 250,
