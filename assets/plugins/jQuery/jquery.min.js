!function (e, t) {
    ...
    var n = [], r = e.document, i = Object.getPrototypeOf, o = n.slice, a = n.concat, s = n.push, u = n.indexOf, l = {},
        c = l.toString, f = l.hasOwnProperty, p = f.toString, d = p.call(Object), h = {}, g = function (e) {
    ...
    var me = r.documentElement, xe = /^key/, be = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        we = /^([^.]*)(?:\.(.+)|)/;
    ...
    b.event = {
        global: {}, add: function (e, t, n, r, i) {
            ...
            var t, n, r, i, o, a, s = b.event.fix(e), u = new Array(arguments.length),
                l = (Y.get(this, "events") || {})[s.type] || [], c = b.event.special[s.type] || {};
    ...
    b.extend({
        htmlPrefilter: function (e) {
            ...
            var r, i, o, a, s, u, l, c = e.cloneNode(!0), f = b.contains(e.ownerDocument, e);
    ...
    var Me = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), Re = function (t) {
    ...
    var Be = /^(none|table(?!-c[ea]).+)/, Fe = /^--/,
        ...
        ze = {letterSpacing: "0", fontWeight: "400"}, Xe = ["Webkit", "Moz", "ms"], Ue = r.createElement("div").style;
    ...
    function Qe(e, t, n) {
        var r = Re(e), i = We(e, t, r), o = "border-box" === b.css(e, "boxSizing", !1, r), a = o;
        if (Me.test(i)) {
            if (!n) return i;
            i = "auto"
        }
    ...
    b.extend({
        ...
        b.cssHooks[t] = {
            get: function (e, n, r) {
                ...
                var i, o = Re(e), a = "border-box" === b.css(e, "boxSizing", !1, o), s = r && Ye(e, t, r, a, o);
    ...
    b.Animation = b.extend(ut, {
        tweeners: {
            ...
            if ((u = !b.isEmptyObject(t)) || !b.isEmptyObject(d)) {
                ...
                for (r in d) u || (v ? "hidden" in v && (g = v.hidden) : v = Y.access(e, "fxshow", {display: l}), o && (v.hidden = !g), g && se([e], !0), p.done(function () {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                var t = !0, i = null != e && e + "queueHooks", o = b.timers, a = Y.get(this);
    ...
    b.extend(b.event, {
        trigger: function (t, n, i, o) {
            var a, s, u, l, c, p, d, h, y = [i || r], m = f.call(t, "type") ? t.type : t,
    ...
    var xt = e.location, bt = Date.now(), wt = /\?/;
    ...
    var Dt = /%20/g, Nt = /#.*$/, At = /([?&])_=[^&]*/, jt = /^(.*?):[ \t]*([^\r\n]*)$/gm, qt = /^(?:GET|HEAD)$/,
        Lt = /^\/\//, Ht = {}, Ot = {}, Pt = "*/".concat("*"), Mt = r.createElement("a");
    ...
    Mt.href = xt.href, b.extend({
        ...
        ajax: function (t, n) {
            ...
            var i, o, a, s, u, l, c, f, p, d, h = b.ajaxSetup({}, n), g = h.context || h,
                v = h.context && (g.nodeType || g.jquery) ? b(g) : b.event, y = b.Deferred(),
                m = b.Callbacks("once memory"), x = h.statusCode || {}, w = {}, T = {}, C = "canceled", E = {
    ...
    var $t = {0: 200, 1223: 204}, Bt = b.ajaxSettings.xhr();
